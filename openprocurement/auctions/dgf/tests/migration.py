...
class MigrateTestFrom1To2WithTwoBids(BaseAuctionWebTest):
    ...
    def test_migrate_cancelled_pending(self):
        auction = self.db.get(self.auction_id)
    ...
    def test_migrate_cancelled_unsuccessful_cancelled_pending(self):
        auction = self.db.get(self.auction_id)
    ...
    def test_migrate_cancelled_unsuccessful_cancelled_active(self):
        auction = self.db.get(self.auction_id)
