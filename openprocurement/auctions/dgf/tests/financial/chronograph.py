...
from openprocurement.auctions.dgf.tests.base import BaseFinancialAuctionWebTest, test_lots, test_financial_bids, test_financial_organization


class AuctionSwitchQualificationResourceTest(BaseFinancialAuctionWebTest):
...
class AuctionSwitchAuctionResourceTest(BaseFinancialAuctionWebTest):
...
class AuctionSwitchUnsuccessfulResourceTest(BaseFinancialAuctionWebTest):
...
class AuctionAuctionPeriodResourceTest(BaseFinancialAuctionWebTest):
    initial_bids = test_financial_bids
...
class AuctionComplaintSwitchResourceTest(BaseFinancialAuctionWebTest):
...
class AuctionAwardComplaintSwitchResourceTest(BaseFinancialAuctionWebTest):
