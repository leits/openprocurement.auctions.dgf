...
from openprocurement.auctions.dgf.tests.base import (BaseFinancialAuctionWebTest,
    test_financial_auction_data, test_features_auction_data, test_financial_organization)

class AuctionBidderResourceTest(BaseFinancialAuctionWebTest):
    initial_data = test_financial_auction_data
    initial_status = 'active.tendering'

    def test_create_auction_bidder_invalid(self):
        response = self.app.post_json('/auctions/some_id/bids', {
                                      'data': {'tenderers': [test_financial_organization], "value": {"amount": 500}, 'selfQualified': True}}, status=404)
        ...
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(response.json['errors'], [
            {u"location": u"body", u"name": u"selfQualified", u"description": [u"This field is required."]},
        ...
        response = self.app.post_json(request_path, {'data': {'tenderers': [test_financial_organization], 'selfQualified': True}}, status=422)
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(response.json['errors'], [
        ...
        response = self.app.post_json(request_path, {'data': {'tenderers': [test_financial_organization], "value": {"amount": 500, 'valueAddedTaxIncluded': False}, 'selfQualified': True}}, status=422)
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(response.json['errors'], [
        ...
        response = self.app.post_json(request_path, {'data': {'tenderers': [test_financial_organization], "value": {"amount": 500, 'currency': "USD"}, 'selfQualified': True}}, status=422)
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(response.json['errors'], [
        ...
        response = self.app.post_json(request_path, {'data': {'tenderers': test_financial_organization, "value": {"amount": 500}, 'selfQualified': True}}, status=422)
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(response.json['errors'], [
        ...
        response = self.app.post_json('/auctions/{}/bids'.format(
            self.auction_id), {'data': {'tenderers': [test_financial_organization], "value": {"amount": 500}}}, status=422)
        self.assertEqual(response.status, '422 Unprocessable Entity')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['status'], 'error')
        self.assertEqual(response.json['errors'], [
    ...
    def test_create_auction_bidder(self):
        ...
        response = self.app.post_json('/auctions/{}/bids'.format(
            self.auction_id), {'data': {'tenderers': [test_financial_organization], "value": {"amount": 500}, 'selfQualified': True}})
        ...
        response = self.app.post_json('/auctions/{}/bids'.format(
            self.auction_id), {'data': {'tenderers': [test_financial_organization], "value": {"amount": 500}, 'selfQualified': True}}, status=403)
    ...
    def test_patch_auction_bidder(self):
        response = self.app.post_json('/auctions/{}/bids'.format(
            self.auction_id), {'data': {'tenderers': [test_financial_organization], "status": "draft", "value": {"amount": 500}, 'selfQualified': True}})
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.content_type, 'application/json')
        bidder = response.json['data']
        ...
        response = self.app.patch_json('/auctions/{}/bids/{}'.format(self.auction_id, bidder['id']), {"data": {"value": {"amount": 500}, 'tenderers': [test_financial_organization]}})
        self.assertEqual(response.status, '200 OK')
        self.assertEqual(response.content_type, 'application/json')
        self.assertEqual(response.json['data']['date'], bidder['date'])
...
class AuctionBidderFeaturesResourceTest(BaseFinancialAuctionWebTest):
...
class AuctionBidderDocumentResourceTest(BaseFinancialAuctionWebTest):
    initial_status = 'active.tendering'
