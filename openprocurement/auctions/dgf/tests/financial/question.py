...
class AuctionQuestionResourceTest(BaseFinancialAuctionWebTest):

    def test_create_auction_question_invalid(self):
        response = self.app.post_json('/auctions/some_id/questions', {
                                      'data': {'title': 'question title', 'description': 'question description', 'author': test_financial_organization}}, status=404)
    ...
    def test_create_auction_question(self):
        response = self.app.post_json('/auctions/{}/questions'.format(
            self.auction_id), {'data': {'title': 'question title', 'description': 'question description', 'author': test_financial_organization}})
        self.assertEqual(response.status, '201 Created')
        self.assertEqual(response.content_type, 'application/json')
        question = response.json['data']
        self.assertEqual(question['author']['name'], test_financial_organization['name'])
        ...
        response = self.app.post_json('/auctions/{}/questions'.format(
            self.auction_id), {'data': {'title': 'question title', 'description': 'question description', 'author': test_financial_organization}}, status=403)
...
class AuctionLotQuestionResourceTest(BaseFinancialAuctionWebTest):
