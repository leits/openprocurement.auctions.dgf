...
from openprocurement.auctions.dgf.tests.base import BaseFinancialAuctionWebTest, test_lots, test_financial_bids


class AuctionCancellationResourceTest(BaseFinancialAuctionWebTest):
...
class AuctionLotCancellationResourceTest(BaseFinancialAuctionWebTest):
    initial_status = 'active.tendering'
...
@unittest.skip("option not available")
class AuctionLotsCancellationResourceTest(BaseFinancialAuctionWebTest):
    initial_status = 'active.tendering'
...
class AuctionCancellationDocumentResourceTest(BaseFinancialAuctionWebTest):
